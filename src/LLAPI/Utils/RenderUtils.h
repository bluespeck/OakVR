...
namespace oakvr
{
	namespace render
	{
		...
		using VertexElementDescriptorArray = std::vector<VertexElementDescriptor>;

		inline auto ComputeVertexStride(const VertexElementDescriptorArray &vertexElementDescriptors) -> uint32_t
		{
			uint32_t stride = 0;
